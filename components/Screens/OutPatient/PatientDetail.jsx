...
const PatientDetail = ({ navigation }) => {
    ...
    return (
        <View style={styles.maincontainer}>
            ...
            <View style={styles.buttonMakeIn}>
                <TouchableOpacity onPress={handleOnMakeInPatient} style={styles.Discharge}><Text style={styles.btntxt}>Make Inpatient</Text></TouchableOpacity>
            </View>
            <View style={styles.buttonDischarge}>
                <TouchableOpacity style={styles.Discharge}><Text style={styles.btntxt}>Discharge</Text></TouchableOpacity>
            </View>
        </View >
    )
}
